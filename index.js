...
app.get('/', (req, res) => {
    res.send('Welcome to Royel');
})
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.g5qv1.mongodb.net/${process.env.DB_NAME}?retryWrites=true&w=majority`;
